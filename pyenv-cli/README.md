...
Synthesized from [AIM v2.2 specification](https://intentmodel.dev) - `pyenv-cli.intent`
...
PyEnvCLI is synthesized from the [AIM v2.2 specification](https://intentmodel.dev/specification) with strict adherence to:
...
**Synthesized by:** AIM v2.2 Synthesizer
